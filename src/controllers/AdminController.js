...
const headingColumnsNames = ['Criado', 'Operador', 'Supervisor', 'Operacional', "Nome","CPF"	,"Data Nasc.",	"Endereço", "Bairro"	,"Cidade",	"UF",	"CEP",	"Contato1",	"Zap",	"Nº Benefício",	"Banco", "Salário",	"Agência",	"Tipo",	"Nº Conta",	"Tipo Conta",	"Banco origem",	"Quitação",	"Valor Parcelas",	"Total Parcelas", "Parcelas restantes", "Parcela desejada", "Qtd Pagas", "Contrato", "Taxa", "Valor liberado" ,	"Status","Obs"]
const Admin = {
  ...
  generate: async function (req, res) {
    ...
    try {
      ...
      result.forEach(record => {
        ...
        ws.cell(rowIndex, 15).string(String(record['Salario']))        
